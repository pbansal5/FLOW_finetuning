...
def setup_logger(log_dir, args):
    ...
    log_file = log_dir / f'logs_linear_{args.model}_{args.dataset}_lr{args.lr}.txt'
...
def test(net, testloader, criterion, device, epoch, best_acc, checkpoint_dir, log_print, args):
    ...
    if acc > best_acc:
        ...
        torch.save(state, checkpoint_dir / f'{args.dataset}/ckpt_linear_{args.model}_{args.dataset}_lr{args.lr}.pth')
...
def main():
    ...
    parser.add_argument('--seed', default=42, type=int,
                        help='random seed')
    parser.add_argument('--checkpoint-dir', default='./checkpoint/linear_probing',
                        type=str, help='checkpoint directory')
    parser.add_argument('--log-dir', default='./logs/linear_probing',
    ...
    checkpoint_path = checkpoint_dir / f'{args.dataset}/ckpt_linear_{args.model}_{args.dataset}_lr{args.lr}.pth'
